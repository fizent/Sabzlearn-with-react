...
return (
  <div>
    ...
    <div className="mx-auto max-w-[1260px] mt-40 mb-20">
      <div>
        <h2 className="font-fontVazir text-4xl py-3">با دوره‌های <span className="text-green-500">سبزلرن</span> برنامه‌نویس حرفه‌ای شوید!</h2>
